...
u2 = general_iterative_solver(step_func, residual_func, state, p, 'u0', u0, 'verbosity', 1);
...
u0 = 0.01*rand(size(state.u0));
u3 = general_iterative_solver(step_func, residual_func, state, p, 'u0', u0, 'verbosity', 1);
