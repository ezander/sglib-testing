function [supp, hn, a1n, a2n, a3n, a4n]=orthpol_info( name, m, variant, params, varargin )

options=varargin2options( varargin{:} );
[normalize,options]=get_option( options, 'normalize', true ); % normalize even if not generally normed
