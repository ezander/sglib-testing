...
if true
    ...
    [X,flag,info1]=tensor_solve_pcg( A, F(:), 'Minv', Pinv1, 'verbosity', 0 );
    [X,flag,info2]=tensor_solve_pcg( A, F(:), 'Minv', Pinv2, 'verbosity', 0 );
    [X,flag,info3]=tensor_solve_pcg( A, F(:), 'Minv', Pinv3, 'verbosity', 0 );
    disp('pcg solve steps')
    info1.iter
    info2.iter
    info3.iter
    [X,flag,info1]=tensor_solve_simple( A, F(:), 'Minv', Pinv1, 'verbosity', 0 );
    [X,flag,info2]=tensor_solve_simple( A, F(:), 'Minv', Pinv2, 'verbosity', 0 );
    [X,flag,info3]=tensor_solve_simple( A, F(:), 'Minv', Pinv3, 'verbosity', 0 );
